...
(function () {
	...
	function Layer(html, opts) {
		...
		headerContent.className = "close headerContent";
	...
	Layer.prototype = {
		init: function () {
			...
			this.el.appendChild(this.headerContent);
			...
			this.headerContent.style.bottom = (this.opts.itemHeight * this.opts.showCount + this.opts.headerHeight) + this.opts.cssUnit;
	...
	IosSelect.prototype = {
		...
		initLayer: function () {
			...
			this.iosSelectLayer = new Layer(all_html, {
				...
				showCount: this.options.itemShowCount,
				headerHeight: this.options.headerHeight,
				cssUnit: this.options.cssUnit
			});
